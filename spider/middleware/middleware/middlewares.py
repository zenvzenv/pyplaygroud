...
class MiddlewareDownloaderMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        # request.meta['proxy'] = "http://106.14.126.247:8080"
        return None
    ...
    def process_response(self, request, response, spider):
        ...
        if request.url in spider.module_urls:
            ...
            # 返回新的响应对象
            # 如何获取
            return HtmlResponse(url=request.url, body=page_html, encoding='utf-8', request=request)
        else:
            return response
